...
def drawGuide(position, orientation, parent):
    ...
    inkex.etree.SubElement(
        parent, '{http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd}guide', {
...
def drawDoubleGuides(colsRows, width, gutter, start_pos, has_outer_gutter,
                     orientation, parent):
        ...
        if (tab == "\"columns\""):
            ...
            if (show_total_width == True):
                printDebug("Total width of grid will be: " +
                           str(total_col_width / col_factor) + " " +
                           self.options.column_unit)
            ...
            if (show_total_height == True):
                printDebug("Total height of grid will be: " +
                           str(total_row_height / row_factor) + " " +
                           self.options.row_unit)
